          ...
          <div className="counter-glass-card rounded-2xl overflow-hidden">
            ...
            >
              <span className="flex items-center gap-3">
                <div className={cn(
                  ...
                  countingTaskEnabled && 'counter-icon-well--active'
                )}>
              ...
              <div
                ...
                className={cn(
                  ...
                  countingTaskEnabled ? 'counter-toggle--on' : 'counter-toggle--off'
                )}
              >
                <span
                  className={cn(
                    'counter-toggle-thumb absolute top-[3px] h-[22px] w-[22px] rounded-full transition-all duration-300',
                    countingTaskEnabled ? 'right-[3px] left-auto' : 'left-[3px] right-auto'
                  )}
                />
              </div>
            </button>
            ...
            <div
              ...
              className={cn(
                ...
                countingTaskEnabled ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
              )}
            >
              <div className="counter-settings-panel px-5 py-4 space-y-4">
                ...
                <div className="flex items-center justify-center gap-3">
                  <button
                    type="button"
                    onClick={() => setTargetQuantity((n) => Math.max(2, n - 10))}
                  ...
                  <div className="counter-display flex flex-col items-center justify-center h-16 w-20 rounded-2xl">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (!isNaN(v) && v >= 2) setTargetQuantity(v)
                      }}
                  ...
                  <button
                    type="button"
                    onClick={() => setTargetQuantity((n) => n + 10)}
                  ...
                  {[5, 10, 15, 20, 30, 50, 100].map((val) => (
                    <button
                      ...
                      className={cn(
                        ...
                        targetQuantity === val && 'counter-preset--active'
                      )}
                    >
                      {val}
                    </button>
                      ...
                      {['раз', 'мин', 'км', 'стр', 'шт'].map((unit) => (
                        <button
                          ...
                          className={cn(
                            ...
                            countUnit === unit && 'counter-chip--active'
                          )}
                        >
                          {unit}
                        </button>
